...
func _init(
	...
	elif p_stat_data.has(GameData.PokemonStat.ATTACK):
		self.attack = p_stat_data[GameData.PokemonStat.ATTACK]
	if p_stat_data.has("defense"):
		self.defense = p_stat_data.defense
	elif p_stat_data.has("def"):
		self.defense = p_stat_data.def
	elif p_stat_data.has(GameData.PokemonStat.DEFENSE):
		self.defense = p_stat_data[GameData.PokemonStat.DEFENSE]
	...
	elif p_stat_data.has(GameData.PokemonStat.SPECIAL_ATTACK):
		self.special_attack = p_stat_data[GameData.PokemonStat.SPECIAL_ATTACK]
	...
	elif p_stat_data.has(GameData.PokemonStat.SPECIAL_DEFENSE):
		self.special_defense = p_stat_data[GameData.PokemonStat.SPECIAL_DEFENSE]
	if p_stat_data.has("speed"):
		self.speed = p_stat_data.speed
	elif p_stat_data.has("spe"):
		self.speed = p_stat_data.spe
	elif p_stat_data.has(GameData.PokemonStat.SPEED):
		self.speed = p_stat_data[GameData.PokemonStat.SPEED]
