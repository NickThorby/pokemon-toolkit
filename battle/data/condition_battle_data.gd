...
var on_accuracy # (this: Battle, accuracy: number, target: BattlePokemon, source: BattlePokemon, move: ActiveMove) -> EHR | void
var on_base_power # (this: Battle, relayVar: EHR, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void
...
var on_critical_hit # ((this: Battle, pokemon: BattlePokemon, source: null, move: ActiveMove) -> EHR | void) | bool
var on_damage # (this: Battle, damage: number, target: BattlePokemon, source: BattlePokemon, effect: Effect) -> EHR | void
var on_deduct_pp # (this: Battle, target: BattlePokemon, source: BattlePokemon) -> EHR | void
...
var on_effectiveness # (this: Battle, typeMod: number, target: BattlePokemon | null, type: string, move: ActiveMove) -> EHR | void
...
var on_flinch # ((this: Battle, pokemon: BattlePokemon) -> EHR | void) | bool
var on_fractional_priority # (this: Battle, relayVar: EHR, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void | -0.1
...
var on_lock_move # string | ((this: Battle, pokemon: BattlePokemon) -> EHR | void)
var on_maybe_trap_pokemon # (this: Battle, pokemon: BattlePokemon) -> void
var on_modify_accuracy # (this: Battle, relayVar: EHR, target: BattlePokemon, source: BattlePokemon, move: ActiveMove) -> EHR | void
var on_modify_atk # (this: Battle, relayVar: EHR, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void
var on_modify_boost # (this: Battle, boosts: Dictionary, pokemon: BattlePokemon) -> EHR | void
var on_modify_crit_ratio # (this: Battle, relayVar: EHR, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void
var on_modify_damage # (this: Battle, relayVar: EHR, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void
var on_modify_def # (this: Battle, relayVar: EHR, target: BattlePokemon, source: BattlePokemon, move: ActiveMove) -> EHR | void
var on_modify_move # (this: Battle, move: ActiveMove, pokemon: BattlePokemon, target: BattlePokemon | null) -> void
var on_modify_priority # (this: Battle, relayVar: EHR, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void
...
var on_modify_target # (this: Battle, relayVar: EHR, pokemon: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> void
var on_modify_spa # (this: Battle, relayVar: EHR, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void
var on_modify_spd # (this: Battle, relayVar: EHR, target: BattlePokemon, source: BattlePokemon, move: ActiveMove) -> EHR | void
var on_modify_spe # (this: Battle, spe: number, pokemon: BattlePokemon) -> EHR | void
var on_modify_weight # (this: Battle, weighthg: number, pokemon: BattlePokemon) -> EHR | void
var on_move_aborted # (this: Battle, target: BattlePokemon, source: BattlePokemon, move: ActiveMove) -> void
var on_negate_immunity # ((this: Battle, pokemon: BattlePokemon, type: string) -> EHR | void) | bool
var on_override_action # (this: Battle, pokemon: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void
var on_prepare_hit # bool | ((this: Battle, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void)
...
var on_set_status # (this: Battle, status: BattleCondition, target: BattlePokemon, source: BattlePokemon, effect: Effect) -> EHR | void
var on_set_weather # (this: Battle, target: BattlePokemon, source: BattlePokemon, weather: BattleCondition) -> EHR | void
var on_stall_move # (this: Battle, pokemon: BattlePokemon) -> EHR | void
...
var on_take_item # ((this: Battle, item: Item, pokemon: BattlePokemon, source: BattlePokemon, move?: ActiveMove) -> EHR | void) | bool
...
var on_try_add_volatile # (this: Battle, status: BattleCondition, target: BattlePokemon, source: BattlePokemon, sourceEffect: Effect) -> EHR | void
var on_try_eat_item # bool | ((this: Battle, item: Item, pokemon: BattlePokemon) -> EHR | void)
var on_try_heal # (((this: Battle, relayVar: EHR, target: BattlePokemon, source: BattlePokemon, effect: Effect) -> EHR | void) |((this: Battle, pokemon: BattlePokemon) -> EHR | void) | bool)
var on_try_hit # bool | ((this: Battle, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void)
var on_try_hit_field # bool | ((this: Battle, target: BattlePokemon, source: BattlePokemon, move: ActiveMove) -> EHR | void)
var on_try_hit_side # bool | ((this: Battle, target: BattlePokemon, source: BattlePokemon, move: ActiveMove) -> EHR | void)
var on_invulnerability # bool | ((this: Battle, target: BattlePokemon, source: BattlePokemon, move: ActiveMove) -> EHR | void)
var on_try_move # bool | ((this: Battle, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void)
var on_try_primary_hit # (this: Battle, target: BattlePokemon, source: BattlePokemon, move: ActiveMove) -> EHR | void
var on_type # (this: Battle, types: string[], pokemon: BattlePokemon) -> EHR | void
...
var on_weather_modify_damage # (this: Battle, relayVar: EHR, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void
var on_modify_damage_phase1 # (this: Battle, relayVar: EHR, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void
var on_modify_damage_phase2 # (this: Battle, relayVar: EHR, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void
...
var on_foe_accuracy # (this: Battle, accuracy: number, target: BattlePokemon, source: BattlePokemon, move: ActiveMove) -> EHR | void
var on_foe_base_power # (this: Battle, relayVar: EHR, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void
...
var on_foe_critical_hit # ((this: Battle, pokemon: BattlePokemon, source: null, move: ActiveMove) -> EHR | void) | bool
var on_foe_damage # (this: Battle, damage: number, target: BattlePokemon, source: BattlePokemon, effect: Effect) -> EHR | void
var on_foe_deduct_pp # (this: Battle, target: BattlePokemon, source: BattlePokemon) -> EHR | void
...
var on_foe_effectiveness # (this: Battle, typeMod: number, target: BattlePokemon | null, type: string, move: ActiveMove) -> EHR | void
var on_foe_faint # (this: Battle, target: BattlePokemon, source: BattlePokemon, effect: Effect) -> void
var on_foe_flinch # ((this: Battle, pokemon: BattlePokemon) -> EHR | void) | bool
var on_foe_hit # bool | ((this: Battle, target: BattlePokemon, source: BattlePokemon, move: ActiveMove) -> EHR | void)
var on_foe_immunity # (this: Battle, type: string, pokemon: BattlePokemon) -> void
var on_foe_lock_move # string | ((this: Battle, pokemon: BattlePokemon) -> EHR | void)
var on_foe_maybe_trap_pokemon # (this: Battle, pokemon: BattlePokemon, source?: BattlePokemon) -> void
var on_foe_modify_accuracy # (this: Battle, relayVar: EHR, target: BattlePokemon, source: BattlePokemon, move: ActiveMove) -> EHR | void
var on_foe_modify_atk # (this: Battle, relayVar: EHR, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void
var on_foe_modify_boost # (this: Battle, boosts: Dictionary, pokemon: BattlePokemon) -> EHR | void
var on_foe_modify_crit_ratio # (this: Battle, relayVar: EHR, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void
var on_foe_modify_damage # (this: Battle, relayVar: EHR, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void
var on_foe_modify_def # (this: Battle, relayVar: EHR, target: BattlePokemon, source: BattlePokemon, move: ActiveMove) -> EHR | void
var on_foe_modify_move # (this: Battle, move: ActiveMove, pokemon: BattlePokemon, target: BattlePokemon | null) -> void
var on_foe_modify_priority # (this: Battle, relayVar: EHR, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void
...
var on_foe_modify_spa # (this: Battle, relayVar: EHR, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void
var on_foe_modify_spd # (this: Battle, relayVar: EHR, target: BattlePokemon, source: BattlePokemon, move: ActiveMove) -> EHR | void
var on_foe_modify_spe # (this: Battle, spe: number, pokemon: BattlePokemon) -> EHR | void
var on_foe_modify_type # (this: Battle, move: ActiveMove, pokemon: BattlePokemon, target: BattlePokemon) -> void
var on_foe_modify_target # (this: Battle, relayVar: EHR, pokemon: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> void
var on_foe_modify_weight # (this: Battle, weighthg: number, pokemon: BattlePokemon) -> EHR | void
var on_foe_move_aborted # (this: Battle, target: BattlePokemon, source: BattlePokemon, move: ActiveMove) -> void
var on_foe_negate_immunity # ((this: Battle, pokemon: BattlePokemon, type: string) -> EHR | void) | bool
var on_foe_override_action # (this: Battle, pokemon: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void
var on_foe_prepare_hit # bool | ((this: Battle, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void)
...
var on_foe_set_ability # (this: Battle, ability: string, target: BattlePokemon, source: BattlePokemon, effect: Effect) -> EHR | void
var on_foe_set_status # (this: Battle, status: BattleCondition, target: BattlePokemon, source: BattlePokemon, effect: Effect) -> EHR | void
var on_foe_set_weather # (this: Battle, target: BattlePokemon, source: BattlePokemon, weather: BattleCondition) -> EHR | void
var on_foe_stall_move # (this: Battle, pokemon: BattlePokemon) -> EHR | void
var on_foe_switch_in # (this: Battle, pokemon: BattlePokemon) -> void
var on_foe_switch_out # (this: Battle, pokemon: BattlePokemon) -> void
var on_foe_take_item # ((this: Battle, item: Item, pokemon: BattlePokemon, source: BattlePokemon, move?: ActiveMove) -> EHR | void) | bool
var on_foe_terrain # (this: Battle, pokemon: BattlePokemon) -> void
var on_foe_trap_pokemon # (this: Battle, pokemon: BattlePokemon) -> void
var on_foe_try_add_volatile # (this: Battle, status: BattleCondition, target: BattlePokemon, source: BattlePokemon, sourceEffect: Effect) -> EHR | void
var on_foe_try_eat_item # bool | ((this: Battle, item: Item, pokemon: BattlePokemon) -> EHR | void)
var on_foe_try_heal # (((this: Battle, relayVar: EHR, target: BattlePokemon, source: BattlePokemon, effect: Effect) -> EHR | void) | ((this: Battle, pokemon: BattlePokemon) -> EHR | void) | bool)
var on_foe_try_hit # bool | ((this: Battle, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void)
var on_foe_try_hit_field # bool | ((this: Battle, target: BattlePokemon, source: BattlePokemon, move: ActiveMove) -> EHR | void)
var on_foe_try_hit_side # bool | ((this: Battle, target: BattlePokemon, source: BattlePokemon, move: ActiveMove) -> EHR | void)
var on_foe_invulnerability # bool | ((this: Battle, target: BattlePokemon, source: BattlePokemon, move: ActiveMove) -> EHR | void)
var on_foe_try_move # bool | ((this: Battle, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void)
var on_foe_try_primary_hit # (this: Battle, target: BattlePokemon, source: BattlePokemon, move: ActiveMove) -> EHR | void
var on_foe_type # (this: Battle, types: string[], pokemon: BattlePokemon) -> EHR | void
var on_foe_weather_modify_damage # (this: Battle, relayVar: EHR, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void
var on_foe_modify_damage_phase1 # (this: Battle, relayVar: EHR, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void
var on_foe_modify_damage_phase2 # (this: Battle, relayVar: EHR, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void
...
var on_source_accuracy # (this: Battle, accuracy: number, target: BattlePokemon, source: BattlePokemon, move: ActiveMove) -> EHR | void
var on_source_base_power # (this: Battle, relayVar: EHR, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void
...
var on_source_critical_hit # ((this: Battle, pokemon: BattlePokemon, source: null, move: ActiveMove) -> EHR | void) | bool
var on_source_damage # (this: Battle, damage: number, target: BattlePokemon, source: BattlePokemon, effect: Effect) -> EHR | void
var on_source_deduct_pp # (this: Battle, target: BattlePokemon, source: BattlePokemon) -> EHR | void
...
var on_source_effectiveness # (this: Battle, typeMod: number, target: BattlePokemon | null, type: string, move: ActiveMove) -> EHR | void
var on_source_faint # (this: Battle, target: BattlePokemon, source: BattlePokemon, effect: Effect) -> void
var on_source_flinch # ((this: Battle, pokemon: BattlePokemon) -> EHR | void) | bool
var on_source_hit # bool | ((this: Battle, target: BattlePokemon, source: BattlePokemon, move: ActiveMove) -> EHR | void)
var on_source_immunity # (this: Battle, type: string, pokemon: BattlePokemon) -> void
var on_source_lock_move # string | ((this: Battle, pokemon: BattlePokemon) -> EHR | void)
var on_source_maybe_trap_pokemon # (this: Battle, pokemon: BattlePokemon) -> void
var on_source_modify_accuracy # (this: Battle, relayVar: EHR, target: BattlePokemon, source: BattlePokemon, move: ActiveMove) -> EHR | void
var on_source_modify_atk # (this: Battle, relayVar: EHR, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void
var on_source_modify_boost # (this: Battle, boosts: Dictionary, pokemon: BattlePokemon) -> EHR | void
var on_source_modify_crit_ratio # (this: Battle, relayVar: EHR, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void
var on_source_modify_damage # (this: Battle, relayVar: EHR, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void
var on_source_modify_def # (this: Battle, relayVar: EHR, target: BattlePokemon, source: BattlePokemon, move: ActiveMove) -> EHR | void
var on_source_modify_move # (this: Battle, move: ActiveMove, pokemon: BattlePokemon, target: BattlePokemon | null) -> void
var on_source_modify_priority # (this: Battle, relayVar: EHR, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void
...
var on_source_modify_spa # (this: Battle, relayVar: EHR, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void
var on_source_modify_spd # (this: Battle, relayVar: EHR, target: BattlePokemon, source: BattlePokemon, move: ActiveMove) -> EHR | void
var on_source_modify_spe # (this: Battle, spe: number, pokemon: BattlePokemon) -> EHR | void
var on_source_modify_type # (this: Battle, move: ActiveMove, pokemon: BattlePokemon, target: BattlePokemon) -> void
var on_source_modify_target # (this: Battle, relayVar: EHR, pokemon: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> void
var on_source_modify_weight # (this: Battle, weighthg: number, pokemon: BattlePokemon) -> EHR | void
var on_source_move_aborted # (this: Battle, target: BattlePokemon, source: BattlePokemon, move: ActiveMove) -> void
var on_source_negate_immunity # ((this: Battle, pokemon: BattlePokemon, type: string) -> EHR | void) | bool
var on_source_override_action # (this: Battle, pokemon: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void
var on_source_prepare_hit # bool | ((this: Battle, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void)
...
var on_source_set_ability # (this: Battle, ability: string, target: BattlePokemon, source: BattlePokemon, effect: Effect) -> EHR | void
var on_source_set_status # (this: Battle, status: BattleCondition, target: BattlePokemon, source: BattlePokemon, effect: Effect) -> EHR | void
var on_source_set_weather # (this: Battle, target: BattlePokemon, source: BattlePokemon, weather: BattleCondition) -> EHR | void
var on_source_stall_move # (this: Battle, pokemon: BattlePokemon) -> EHR | void
...
var on_source_take_item # ((this: Battle, item: Item, pokemon: BattlePokemon, source: BattlePokemon, move?: ActiveMove) -> EHR | void) | bool
...
var on_source_try_add_volatile # (this: Battle, status: BattleCondition, target: BattlePokemon, source: BattlePokemon, sourceEffect: Effect) -> EHR | void
var on_source_try_eat_item # bool | ((this: Battle, item: Item, pokemon: BattlePokemon) -> EHR | void)
var on_source_try_heal # (((this: Battle, relayVar: EHR, target: BattlePokemon, source: BattlePokemon, effect: Effect) -> EHR | void) | ((this: Battle, pokemon: BattlePokemon) -> EHR | void) | bool)
var on_source_try_hit # bool | ((this: Battle, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void)
var on_source_try_hit_field # bool | ((this: Battle, target: BattlePokemon, source: BattlePokemon, move: ActiveMove) -> EHR | void)
var on_source_try_hit_side # bool | ((this: Battle, target: BattlePokemon, source: BattlePokemon, move: ActiveMove) -> EHR | void)
var on_source_invulnerability # bool | ((this: Battle, target: BattlePokemon, source: BattlePokemon, move: ActiveMove) -> EHR | void)
var on_source_try_move # bool | ((this: Battle, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void)
var on_source_try_primary_hit # (this: Battle, target: BattlePokemon, source: BattlePokemon, move: ActiveMove) -> EHR | void
var on_source_type # (this: Battle, types: string[], pokemon: BattlePokemon) -> EHR | void
var on_source_weather_modify_damage # (this: Battle, relayVar: EHR, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void
var on_source_modify_damage_phase1 # (this: Battle, relayVar: EHR, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void
var on_source_modify_damage_phase2 # (this: Battle, relayVar: EHR, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void
...
var on_any_accuracy # (this: Battle, accuracy: number, target: BattlePokemon, source: BattlePokemon, move: ActiveMove) -> EHR | void
var on_any_base_power # (this: Battle, relayVar: EHR, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void
...
var on_any_critical_hit # ((this: Battle, pokemon: BattlePokemon, source: null, move: ActiveMove) -> EHR | void) | bool
var on_any_damage # (this: Battle, damage: number, target: BattlePokemon, source: BattlePokemon, effect: Effect) -> EHR | void
var on_any_deduct_pp # (this: Battle, target: BattlePokemon, source: BattlePokemon) -> EHR | void
...
var on_any_effectiveness # (this: Battle, typeMod: number, target: BattlePokemon | null, type: string, move: ActiveMove) -> EHR | void
var on_any_faint # (this: Battle, target: BattlePokemon, source: BattlePokemon, effect: Effect) -> void
var on_any_flinch # ((this: Battle, pokemon: BattlePokemon) -> EHR | void) | bool
var on_any_hit # bool | ((this: Battle, target: BattlePokemon, source: BattlePokemon, move: ActiveMove) -> EHR | void)
var on_any_immunity # (this: Battle, type: string, pokemon: BattlePokemon) -> void
var on_any_lock_move # string | ((this: Battle, pokemon: BattlePokemon) -> EHR | void)
var on_any_maybe_trap_pokemon # (this: Battle, pokemon: BattlePokemon) -> void
var on_any_modify_accuracy # (this: Battle, relayVar: EHR, target: BattlePokemon, source: BattlePokemon, move: ActiveMove) -> EHR | void
var on_any_modify_atk # (this: Battle, relayVar: EHR, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void
var on_any_modify_boost # (this: Battle, boosts: Dictionary, pokemon: BattlePokemon) -> EHR | void
var on_any_modify_crit_ratio # (this: Battle, relayVar: EHR, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void
var on_any_modify_damage # (this: Battle, relayVar: EHR, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void
var on_any_modify_def # (this: Battle, relayVar: EHR, target: BattlePokemon, source: BattlePokemon, move: ActiveMove) -> EHR | void
var on_any_modify_move # (this: Battle, move: ActiveMove, pokemon: BattlePokemon, target: BattlePokemon | null) -> void
var on_any_modify_priority # (this: Battle, relayVar: EHR, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void
...
var on_any_modify_spa # (this: Battle, relayVar: EHR, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void
var on_any_modify_spd # (this: Battle, relayVar: EHR, target: BattlePokemon, source: BattlePokemon, move: ActiveMove) -> EHR | void
var on_any_modify_spe # (this: Battle, spe: number, pokemon: BattlePokemon) -> EHR | void
var on_any_modify_type # (this: Battle, move: ActiveMove, pokemon: BattlePokemon, target: BattlePokemon) -> void
var on_any_modify_target # (this: Battle, relayVar: EHR, pokemon: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> void
var on_any_modify_weight # (this: Battle, weighthg: number, pokemon: BattlePokemon) -> EHR | void
var on_any_move_aborted # (this: Battle, target: BattlePokemon, source: BattlePokemon, move: ActiveMove) -> void
var on_any_negate_immunity # ((this: Battle, pokemon: BattlePokemon, type: string) -> EHR | void) | bool
var on_any_override_action # (this: Battle, pokemon: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void
var on_any_prepare_hit # bool | ((this: Battle, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void)
...
var on_any_set_ability # (this: Battle, ability: string, target: BattlePokemon, source: BattlePokemon, effect: Effect) -> EHR | void
var on_any_set_status # (this: Battle, status: BattleCondition, target: BattlePokemon, source: BattlePokemon, effect: Effect) -> EHR | void
var on_any_set_weather # (this: Battle, target: BattlePokemon, source: BattlePokemon, weather: BattleCondition) -> EHR | void
var on_any_stall_move # (this: Battle, pokemon: BattlePokemon) -> EHR | void
var on_any_switch_in # (this: Battle, pokemon: BattlePokemon) -> void
var on_any_switch_out # (this: Battle, pokemon: BattlePokemon) -> void
var on_any_take_item # ((this: Battle, item: Item, pokemon: BattlePokemon, source: BattlePokemon, move?: ActiveMove) -> EHR | void) | bool
var on_any_terrain # (this: Battle, pokemon: BattlePokemon) -> void
var on_any_trap_pokemon # (this: Battle, pokemon: BattlePokemon) -> void
var on_any_try_add_volatile # (this: Battle, status: BattleCondition, target: BattlePokemon, source: BattlePokemon, sourceEffect: Effect) -> EHR | void
var on_any_try_eat_item # bool | ((this: Battle, item: Item, pokemon: BattlePokemon) -> EHR | void)
var on_any_try_heal # (((this: Battle, relayVar: EHR, target: BattlePokemon, source: BattlePokemon, effect: Effect) -> EHR | void) | ((this: Battle, pokemon: BattlePokemon) -> EHR | void) | bool)
var on_any_try_hit # bool | ((this: Battle, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void)
var on_any_try_hit_field # bool | ((this: Battle, target: BattlePokemon, source: BattlePokemon, move: ActiveMove) -> EHR | void)
var on_any_try_hit_side # bool | ((this: Battle, target: BattlePokemon, source: BattlePokemon, move: ActiveMove) -> EHR | void)
var on_any_invulnerability # bool | ((this: Battle, target: BattlePokemon, source: BattlePokemon, move: ActiveMove) -> EHR | void)
var on_any_try_move # bool | ((this: Battle, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void)
var on_any_try_primary_hit # (this: Battle, target: BattlePokemon, source: BattlePokemon, move: ActiveMove) -> EHR | void
var on_any_type # (this: Battle, types: string[], pokemon: BattlePokemon) -> EHR | void
var on_any_weather_modify_damage # (this: Battle, relayVar: EHR, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void
var on_any_modify_damage_phase1 # (this: Battle, relayVar: EHR, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void
var on_any_modify_damage_phase2 # (this: Battle, relayVar: EHR, source: BattlePokemon, target: BattlePokemon, move: ActiveMove) -> EHR | void
...
var on_start # (this: Battle, target: BattlePokemon, source: BattlePokemon, source_effect: Effect) -> EHR | void
